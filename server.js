 ...
 * This script acts as the server
 * More specifically: A Node server
 
*/


const http = require('http'); // import a node package (http), to make into an http server, to make http calls to
...
const port = normalizePort(process.env.PORT || '3000'); //if it receives port value, it runs on process... if not on 3000
app.set('port', port);
